...
namespace OutlookAddIn
{
    partial class FormRegion2
    {
        ...
        [Microsoft.Office.Tools.Outlook.FormRegionName("OutlookAddIn.FormRegion2")]
        public partial class FormRegion2Factory
        {
            ...
            {
                Console.WriteLine(e.OutlookItem.GetType());
            }
        }
        ...
        {
            this.OutlookFormRegion.Visible = !this.OutlookFormRegion.Visible;
        }
    }
}
